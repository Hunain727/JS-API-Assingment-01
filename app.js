        ...
        container.innerHTML += `
            <div class="card" data-userid="${item.userId}">
                <div class="head">
                    ...
                    <h3 style="color: #6366f1;">User Post</h3>
                </div>
                <h5 style="text-align:center; color: #333; text-transform: capitalize;">${item.title}</h5>
                <p>${item.body}</p>
                <button class="detail_btn" style="background-color: #6366f1; color: white; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer; width: 100%;">Interested</button>
            </div>
        `;
    });
})
        ...
        .then(user => {
            card.innerHTML = `
                <div class="head">
                    ...
                    <h3 style="color: #6366f1;">${user.name}</h3>
                </div>
                <p><b>Email:</b> ${user.email}</p>
                <p><b>Phone:</b> ${user.phone}</p>
                <p><b>Company:</b> ${user.company.name}</p>
                <button class="back_btn" style="background-color: #4b5563; color: white; border: none; padding: 10px 15px; border-radius: 5px; cursor: pointer; width: 100%;">Back</button>
            `;
        });
    }
